          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-8 offset-sm-2 text-orange-600 text-center -mt-52">
                ...
                <Link
                  to="/"
                  className=" px-5 py-3 text-sm shadow-lg font-medium tracking-wider text-white border rounded-full hover:shadow-xl btn btn-sm bg-orange-600 hover:bg-white hover:border-orange-600 hover:text-orange-600 focus:outline-none transition duration-500 ease-in-out"
                >
                  Go to Home Page
                </Link>
              </div>
