        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-red-500 text-white px-4 py-2 rounded hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Logout
            </button>
            <button
            ...
            {user.isAdmin && (
              <Link
                to="/admin/dashboard"
                className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Dashboard
              </Link>
            )}
